...
const zooAnimals = [
  ...
  */
  const lowPopulationAnimals = zooAnimals.filter(function(less){
  ...
  */
  let populationTotal = zooAnimals.reduce(function(acc,cur){
    console.log(acc);
    console.log(`acc ${cur.population}`);
 ...
 const multiply(item1,item2) => item1 * item2
 
  const greeting(item1,item2) => `Hello ${item1} ${item2}, nice to meet you!`
